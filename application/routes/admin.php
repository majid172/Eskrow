...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('CategoryController')->prefix('category')->group(function () {
        ...
        Route::post('list', 'store')->name('category.list');
        Route::post('active/{id}', 'active')->name('category.active');
        Route::post('deactive/{id}', 'deactive')->name('category.deactive');
    }
    );
    ...
    Route::controller('EscrowController')->name('escrow.')->prefix('escrow')->group(function () {
        ...
        Route::get('/not_accepted', 'notAccepted')->name('not_accepted');
        Route::get('/disputed', 'disputed')->name('disputed');
        Route::post('dispute/action', 'action')->name('dispute.action');
        Route::get('/dispatched', 'dispatched')->name('dispatched');
        Route::get('/canceled', 'canceled')->name('cancelled');
    ...
    // charge settings..
    Route::controller('EscrowChargeController')->prefix('escrow')->group(function () {
        Route::get('charge', 'index')->name('charge');
        Route::post('escrow/charge', 'escrowCharge')->name('escrowCharge');
        Route::post('general/charge', 'generalCharge')->name('generalCharge');
