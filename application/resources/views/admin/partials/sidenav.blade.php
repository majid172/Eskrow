    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                {{-- escrow --}}
                <li class="sidebar__menu-header">@lang('Escrow Management')</li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.escrow.*')}}">
                    <a href="{{ route('admin.escrow.list') }}" class="nav-link"
                        data-default-url="{{ route('admin.escrow.list') }}">
                        <i class="menu-icon las la-handshake"></i>
                        <span class="menu-title">@lang('Manage Escrow') </span>
                    </a>
                </li>

                <li class="sidebar__menu-header">@lang('Charge Settings')</li>
                <li class="sidebar-menu-item  {{menuActive('admin.charge.*')}}">
                    <a href="{{ route('admin.charge') }}" class="nav-link"
                        data-default-url="{{ route('admin.charge') }}">
                        <i class="menu-icon las la-dollar-sign"></i>
                        <span class="menu-title">@lang('Manage Charge') </span>
                    </a>
                </li>
