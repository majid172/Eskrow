...
class SiteController extends Controller
{
    ...
    public function blogs()
    {
        ...
        return view($this->activeTemplate.'blogs',compact('pageTitle','blogs','sections','latests','categories'));
    }
    ...
    public function blogDetails($slug,$id){
        ...
        return view($this->activeTemplate.'blog_details',compact('blog','pageTitle','latests','categories'));
    }
